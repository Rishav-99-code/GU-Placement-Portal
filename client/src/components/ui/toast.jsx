  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "success" && "border-green-500 bg-green-100 text-green-900",
        variant === "error" && "border-red-500 bg-red-100 text-red-900",
        variant === "info" && "border-blue-500 bg-blue-100 text-blue-900",
        className
      )}
      {...props} />
  )
